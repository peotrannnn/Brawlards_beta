...
export const COLLISION_MASKS = {
    ...
    BALL: COLLISION_GROUPS.STATIC | COLLISION_GROUPS.BALL | COLLISION_GROUPS.PLAYER | COLLISION_GROUPS.RAIL | COLLISION_GROUPS.TRIGGER | COLLISION_GROUPS.CUE | COLLISION_GROUPS.ITEM | COLLISION_GROUPS.HAZARD,
    // Body chính của Player va chạm với STATIC, BALL, ITEM và TRIGGER (để kích hoạt event)
    PLAYER: COLLISION_GROUPS.STATIC | COLLISION_GROUPS.BALL | COLLISION_GROUPS.TRIGGER | COLLISION_GROUPS.ITEM | COLLISION_GROUPS.HAZARD, // Player không còn va chạm với CUE của chính nó
    CUE: COLLISION_GROUPS.BALL | COLLISION_GROUPS.ITEM | COLLISION_GROUPS.HAZARD, // Cây cơ va chạm với bi, item và hazard
    RAIL: COLLISION_GROUPS.STATIC | COLLISION_GROUPS.BALL | COLLISION_GROUPS.PLAYER | COLLISION_GROUPS.ITEM | COLLISION_GROUPS.HAZARD, // Table va chạm với BALL, PLAYER, ITEM, HAZARD và STATIC
    ...
    ITEM: COLLISION_GROUPS.STATIC | COLLISION_GROUPS.BALL | COLLISION_GROUPS.PLAYER | COLLISION_GROUPS.ITEM | COLLISION_GROUPS.CUE | COLLISION_GROUPS.HAZARD, // Item va chạm với mọi thứ, gồm cả cue và hazard
    HAZARD: COLLISION_GROUPS.STATIC | COLLISION_GROUPS.BALL | COLLISION_GROUPS.PLAYER | COLLISION_GROUPS.RAIL | COLLISION_GROUPS.ITEM | COLLISION_GROUPS.CUE | COLLISION_GROUPS.HAZARD
};
